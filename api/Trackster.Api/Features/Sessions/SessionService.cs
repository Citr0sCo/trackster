...
public class SessionService
{
    ...
    public async Task<Session?> GetSessionByUserIdentifier(Guid userIdentifier)
    {
        var sessionRecord = await _sessionRepository.GetSessionByUserIdentifier(userIdentifier);
